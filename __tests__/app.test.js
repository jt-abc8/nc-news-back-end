...
describe("/api/comments/:comment_id", () => {
   ...
   describe("PATCH", () => {
      describe("200 OK", () => {
         test("increments the selected comment's votes data and responds with the updated comment", () => {
            return request(app)
      ...
      describe("400 Bad Request", () => {
         ...
         test("responds with a bad request when comment_id parameter is invalid", () => {
            return request(app)
      ...
      describe("404 Not Found", () => {
         test(
            "Responds with a 404 Not Found message when the comment_id does not exist", () => {
               return request(app)
               .patch("/api/comments/5042")
               .send({
                  inc_votes: 5,
               })
               .expect(404)
